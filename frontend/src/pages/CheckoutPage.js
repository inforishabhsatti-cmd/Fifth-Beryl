  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const orderData = {
        ...
        total_amount: cartTotal,
        coupon_code: discount.isValid ? discount.code : undefined
      };
    ...
    <div className="min-h-screen bg-white pt-32">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <motion.h1
          ...
          className="text-4xl font-bold mb-10 playfair text-black pt-12"
        >
          Checkout
        </motion.h1>
                  ...
                  {discount.amount > 0 && (
                    <div className="flex justify-between mb-2 text-sm text-green-600 font-semibold border-b border-gray-200 pb-2">
                      <span className="flex items-center">
                        <IndianRupee size={14} className="mr-1" /> Discount
                      </span>

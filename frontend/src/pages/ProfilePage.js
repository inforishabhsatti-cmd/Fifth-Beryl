          ...
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8" data-testid="products-grid">
              {filteredProducts.map((product, index) => (
                ...
                >
                  {/* --- MODIFIED: Added colored shadow --- */}
                  <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-green-700/20 transition-all duration-300 hover:-translate-y-2">
